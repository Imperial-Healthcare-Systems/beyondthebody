// Chromatic Waves — Originkit (client-supplied UI element, 2026-07-17)
// Used as the animated background of the PDP "The Blueprint" beat.
// Client-chosen props (fixed): speed 1, bgColor "#1E0000", cellSize 7.
// Only the dot PALETTE (`colors`) is tuned to the house look.
// Renamed from DottedBg2 → ChromaticWaves; body otherwise verbatim.
